...
const ProgressLoader = ({ progress }: { progress: number }) => {
  ...
  return (
    ...
    >
      <div className="w-64 sm:w-80 space-y-3 font-mono text-center select-none bg-[#3c3c3c]/90 p-4 rounded-xs">
        ...
        {/* Completely Borderless Loading / Scroll Bar */}
        <div className="w-full bg-[#1c1c1c] h-3.5 rounded-xs overflow-hidden">
          <div
